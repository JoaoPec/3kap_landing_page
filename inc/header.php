    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    ...
                    <div class="relative group">
                        <button class="flex items-center gap-1 text-sm font-medium text-slate-600 hover:text-primary transition-colors">Conteúdos <svg class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></button>
                        <div class="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            <div class="bg-white rounded-xl shadow-lg border border-slate-100 p-2 min-w-[200px]">
                                <a href="<?= url('servicos/cursos.php') ?>" class="block px-4 py-2.5 text-sm <?= $isCursos ? 'text-primary font-medium bg-slate-50' : 'text-slate-600 hover:text-primary hover:bg-slate-50' ?> rounded-lg transition-colors">3kap Academy</a>
                                <a href="<?= url('blog.php') ?>" class="block px-4 py-2.5 text-sm <?= $isBlog ? 'text-primary font-medium bg-slate-50' : 'text-slate-600 hover:text-primary hover:bg-slate-50' ?> rounded-lg transition-colors">Artigos</a>
                            </div>
                        </div>
                    </div>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-slate-100">
            <nav class="max-w-7xl mx-auto px-4 py-4 space-y-1">
                ...
                <span class="block py-2 px-4 text-xs font-semibold text-slate-400 uppercase">Conteúdos</span>
                <a href="<?= url('servicos/cursos.php') ?>" class="block py-2 pl-6 pr-4 text-slate-600 hover:text-primary transition-colors">3kap Academy</a>
                <a href="<?= url('blog.php') ?>" class="block py-2 pl-6 pr-4 text-slate-600 hover:text-primary transition-colors">Artigos</a>
