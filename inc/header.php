...
?>
    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-28 min-h-[72px]">
                <a href="<?= url('index.php') ?>" class="flex items-center gap-2">
                    <img src="<?= asset('assets/img/logo_3kap.png') ?>" alt="3KAP - Auditoria, RH e TI" class="h-[72px] sm:h-28 w-auto object-contain flex-shrink-0">
                </a>
