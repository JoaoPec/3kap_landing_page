...
<section class="relative pt-28 pb-12 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h1 class="text-3xl md:text-4xl font-bold text-white leading-tight font-display">Auditoria <span class="text-secondary-light">contábil e independente</span></h1>
                <a href="https://wa.me/5571999153592?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20servi%C3%A7os%20de%20Auditoria" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold text-white bg-secondary hover:bg-secondary-dark transition-all shadow-lg shrink-0">
    ...
    <section id="servicos-auditoria" class="py-16 md:py-20 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-16">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-800 mb-8 font-display">Líder em <span class="gradient-text">Auditoria</span></h2>
                <div class="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-200 shadow-sm">
                    <div class="flex-shrink-0 w-32 h-40 md:w-40 md:h-48 rounded-2xl overflow-hidden shadow-lg mx-auto md:mx-0">
                        <img src="<?= asset('assets/img/Tiagofoto1.png') ?>" alt="Tiago Falcão - Líder em Auditoria na 3KAP" class="w-full h-full object-cover object-top">
                    </div>
            ...
            <h2 class="text-lg font-semibold text-slate-600 mb-4 mt-10">Serviços</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="#auditoria-contabil" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#prestacoes-contas" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria de Prestações de Contas
                </a>
                <a href="#entidades-cebas" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria para Entidades com CEBAS
                </a>
                <a href="#valuation" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Valuation (Avaliação Econômico-Financeira)
                </a>
                <a href="#due-diligence" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Due Diligence Contábil e Financeira
                </a>
                <a href="#conformidade-legal" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria de Conformidade Legal e Regulatória
                </a>
                <a href="#controles-internos" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria de Controles Internos
                </a>
                <a href="#auditoria-operacional" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria Operacional
                </a>
                <a href="#trabalhista-previdenciaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria Trabalhista e Previdenciária
                </a>
                <a href="#auditoria-tributaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria Tributária
                </a>
                <a href="#ativos-patrimonio" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria de Ativos e Patrimônio
                </a>
                <a href="#inventario-patrimonial" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Inventário Patrimonial
                </a>
                <a href="#investigativa-fraude" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                    Auditoria Investigativa de Fraude
                </a>
                <a href="#contratos-convenios" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
                ...
                <a href="#consultoria-tributaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </span>
    ...
    <section class="py-12 bg-slate-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            <article id="auditoria-contabil" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="prestacoes-contas" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="entidades-cebas" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="valuation" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="due-diligence" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="conformidade-legal" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="controles-internos" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="auditoria-operacional" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="trabalhista-previdenciaria" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="auditoria-tributaria" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="ativos-patrimonio" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="inventario-patrimonial" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="investigativa-fraude" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="contratos-convenios" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="fins-especificos" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-primary to-primary-light rounded-3xl p-8 md:p-16 relative overflow-hidden">
                ...
                <div class="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <a href="https://wa.me/5571999153592?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20servi%C3%A7os%20de%20Auditoria" target="_blank" class="inline-flex items-center justify-center px-8 py-4 rounded-lg font-semibold text-white bg-secondary hover:bg-secondary-dark transition-all shadow-lg">Falar no WhatsApp</a>
                </div>
            </div>
        </div>
    </section>
