    ...
    <section id="servicos-auditoria" class="py-16 md:py-20 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="#auditoria-contabil" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#prestacoes-contas" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#entidades-cebas" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg></span>
                    Auditoria para Entidades com CEBAS
                </a>
                <a href="#valuation" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#due-diligence" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#conformidade-legal" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2"/></svg></span>
                    Auditoria de Conformidade Legal e Regulatória
                </a>
                <a href="#controles-internos" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#auditoria-operacional" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center"><svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg></span>
                    Auditoria Operacional
                </a>
                <a href="#trabalhista-previdenciaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#auditoria-tributaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></span>
                    Auditoria Tributária
                </a>
                <a href="#ativos-patrimonio" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center"><svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg></span>
                    Auditoria de Ativos e Patrimônio
                </a>
                <a href="#inventario-patrimonial" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#investigativa-fraude" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></span>
                    Auditoria Investigativa de Fraude
                </a>
                <a href="#contratos-convenios" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#fins-especificos" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center"><svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg></span>
                    Auditoria para Fins Específicos
                </a>
                <a href="#consultoria-tributaria" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></span>
