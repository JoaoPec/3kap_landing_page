...
?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-16">
                ...
                <div class="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start bg-white rounded-2xl p-8 md:p-10 border border-slate-200 shadow-sm">
                    <div class="flex-shrink-0 w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden shadow-lg mx-auto md:mx-0 bg-primary/10 flex items-center justify-center">
                        <span class="text-primary text-2xl font-semibold">TI</span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-xl font-bold text-slate-800 font-display">Marcos Andrade</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="#consultoria-ti" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#sistemas-personalizados" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#seguranca-iso27001" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></span>
                    Segurança da Informação (ISO 27001)
                </a>
                <a href="#lgpd" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#iso9001" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#sites-institucionais" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#landing-pages" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#apps-web-moveis" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#ecommerce" class="flex items-center gap-3 p-5 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-secondary/30 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center"><svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg></span>
                    E-commerce
                </a>
            </div>
        </div>
    ...
    <section class="py-12 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            ...
            <article id="apps-web-moveis" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border border-slate-100 shadow-sm">
            ...
            <article id="ecommerce" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border border-slate-100 shadow-sm">
