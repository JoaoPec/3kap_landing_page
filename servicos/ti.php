...
?>
    <section class="relative pt-28 pb-12 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h1 class="text-3xl md:text-4xl font-bold text-white leading-tight font-display">Tecnologia da <span class="text-secondary-light">Informação</span></h1>
                <a href="https://wa.me/5571999153592?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20Tecnologia%20da%20Informa%C3%A7%C3%A3o" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold text-white bg-secondary hover:bg-secondary-dark transition-all shadow-lg shrink-0"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>Falar no WhatsApp</a>
            </div>
        </div>
    </section>

    <section id="servicos-ti" class="py-16 md:py-20 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-16">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-800 mb-8 font-display">Líder em <span class="gradient-text">TI</span></h2>
                <div class="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-200 shadow-sm">
                    <div class="flex-shrink-0 w-32 h-40 md:w-40 md:h-48 rounded-2xl overflow-hidden shadow-lg mx-auto md:mx-0">
                        <img src="<?= asset('assets/img/marco-andrade.jpeg') ?>" alt="Marcos Andrade - Líder de Tecnologia da Informação na 3KAP" class="w-full h-full object-cover object-top">
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-xl font-bold text-slate-800 font-display">Rodrigo Abreu</p>
                        <p class="text-primary font-semibold mb-4">Líder de Tecnologia da Informação</p>
                        <p class="text-slate-600 mb-4">Profissional de tecnologia com experiência em tradução de necessidades de negócio em soluções digitais, atuando desde a descoberta de requisitos até a sustentação de produtos e sistemas.</p>
                        <p class="text-slate-600 mb-0">Tem trajetória em governança de TI, segurança da informação e qualidade, com projetos envolvendo COBIT, ISO 27001 e ISO 9001, sempre focado em reduzir riscos, retrabalho e aumentar a confiabilidade dos dados.</p>
                    </div>
                </div>
            </div>
            <h2 class="text-lg font-semibold text-slate-600 mb-4">Serviços</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="#consultoria-ti" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center"><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg></span>
                    Consultoria em TI
                </a>
                <a href="#sistemas-personalizados" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#seguranca-iso27001" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center"><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg></span>
                    Segurança da Informação (ISO 27001)
                </a>
                <a href="#lgpd" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center"><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg></span>
                    LGPD e Privacidade
                </a>
                <a href="#iso9001" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#sites-institucionais" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#landing-pages" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                ...
                <a href="#apps-web-moveis" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
                    <span class="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center"><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></span>
                    Aplicativos Web e Móveis
                </a>
                <a href="#ecommerce" class="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-slate-200 shadow-sm hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left font-medium text-slate-800">
    ...
    <section class="py-12 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            <article id="consultoria-ti" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="sistemas-personalizados" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="seguranca-iso27001" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="lgpd" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="iso9001" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="sites-institucionais" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="landing-pages" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
            ...
            <article id="apps-web-moveis" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
                <div class="flex items-center gap-3 mb-4"><span class="flex-shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg></span><h3 class="text-xl md:text-2xl font-bold text-slate-800 font-display">Aplicativos Web e Móveis</h3></div>
                <p class="text-slate-600 leading-relaxed mb-6">Criamos aplicativos web e móveis sob medida que proporcionam experiências excepcionais aos usuários, ajudando as empresas a alcançar seus objetivos de negócios.</p>
                <p class="text-slate-600 leading-relaxed mb-6">Soluções responsivas para navegador e apps nativos ou híbridos para Android e iOS, com foco em usabilidade, performance e integração com seus processos.</p>
                <a href="https://wa.me/5571999153592?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20Aplicativos%20Web%20e%20M%C3%B3veis" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-medium text-secondary hover:text-secondary-dark transition-colors">Falar no WhatsApp sobre este serviço</a>
            </article>
            <article id="ecommerce" class="scroll-mt-28 bg-white rounded-2xl p-8 md:p-10 border-2 border-slate-100 shadow-sm">
                <div class="flex items-center gap-3 mb-4"><span class="flex-shrink-0 w-10 h-10 rounded-lg bg-secondary/10 flex items-center justify-center"><svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg></span><h3 class="text-xl md:text-2xl font-bold text-slate-800 font-display">E-commerce</h3></div>
                <p class="text-slate-600 leading-relaxed mb-6">Construímos plataformas de comércio eletrônico escaláveis e seguras que permitem aos nossos clientes venderem seus produtos e serviços online de forma eficiente.</p>
                <p class="text-slate-600 leading-relaxed mb-6">Loja virtual com catálogo, carrinho, pagamentos integrados, gestão de pedidos e relatórios, com design atraente e responsivo e políticas transparentes.</p>
                <a href="https://wa.me/5571999153592?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20E-commerce" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-medium text-secondary hover:text-secondary-dark transition-colors">Falar no WhatsApp sobre este serviço</a>
            </article>
        </div>
    </section>
